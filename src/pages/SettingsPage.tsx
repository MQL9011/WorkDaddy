        ...
        <Modal
          ...
          footer={(
            <>
              ...
              <button type="button" className="button button--danger" disabled={resetting} onClick={() => { void resetBrowser() }}>{resetting ? t('settings.confirmReset.clearing') : t('settings.confirmReset.clear')}</button>
            </>
          )}
        >
          <p>{t('settings.confirmReset.body')}</p>
